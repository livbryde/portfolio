...
== Description ==
Blog  Personal is clean, well structured, sparkling, user-friendly, flexible, dynamic and attention-grabbing WordPress Magazine Theme with a sleek feel that’s perfect for news sites, editorial websites and online magazines.
...
We have integrated One click demo import features which is the most useful features that of  Blog  Personal theme have. Users love to start the website development process at the same starting point as the theme demo page, so they can quickly develop the website they want.
For more details:
https://theme404.com/downloads/blog-personal/
Demo: https://theme404.com/preview/?demo=blog-personal
...
Blog Personal includes support for Infinite Scroll in Jetpack.

== License ==

Blog Personal WordPress Theme, Copyright (C) 2018, Theme404
Blog Personal is distributed under the terms of the GNU GPL
...
== Images ==
    ...
    https://pixabay.com/en/technology-equipment-machine-aerial-3167297/  
    https://pixabay.com/en/adult-beautiful-beauty-cute-face-1867889/ 

    Other images in screenshot are self created and all are under GPLv2.

    Other Images:
        screenshot.png self created GPLv2
        error-img.png.png self created GPLv2 
== Php File ==        
Breadcrumb Trail: 
...
== Changelog ==
== 2.0.0 - Jan 16 2020 ==
* Fixed the issue author
* Remove demo content( Theme are not allowed to have xml content.)
...
* Tested upto 5.0.3.
* changed readme file according to new format.
* Added options to disable/enable date, author and categories
...
== 1.0.6 - July 20 2018 ==
* Added options for scroll back
* Added options for post nav.

== 1.0.5 - July 9 2018 ==
* Added One Click Demo Import for Travel
* Tested upto 4.9.7.

== 1.0.4 - July 2 2018 ==
* Fix issue of prefixing.
...
== 1.0.2 - June 26 2018 ==
* Fix the issue of Pagination.
* Minor Changes in css.
* Added options for header options.
